  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (err.response) {
        ...
        // Error de conexión
        errorMessage = "Error de conexión. Verifica que el servidor esté funcionando en http://localhost:3001";
      } else if (err.message) {
          ...
          <Grid item xs={12} md={6}>
            <LeftPanel>
              <Box sx={{ maxWidth: '400px', mx: 'auto', width: '100%' }}>
                ...
                >
                  Bienvenido(a) al sistema de control de la Hacienda La Vega. Gestiona tus áreas, hotel y más de manera eficiente.
                </Typography>
              </Box>
